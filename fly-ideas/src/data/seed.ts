...
export const SEED_REFERENCES_EXTRA: Reference[] = [
  ...
  },
  {
    ...
    notes: "Угасание у мухи — не стирание, а параллельная противоположная память. Ключевая рамка для «переучить и вспомнить первое». Проверить DOI.",
    createdAt: now,
  },
  {
    id: "r-lin2014",
...
6. Расширение: цепочка D → O1 → O2 → … — деградирует ли «культурная» передача (Danchin 2018).
...
Сначала — игрушечная модель MB на numpy (есть в experiments/templates), затем перенос на реальный контур из коннектома.`,
    validation: "Психология памяти у человека и грызунов: Bouton 2004 (спонтанное восстановление, renewal); у мухи — Felsenberg 2017/2018 (угасание как параллельная память), реверсивное обучение, ёмкость MB (Lin 2014).",
    venues: ["eLife", "PLoS Comp Bio", "Learn Mem", "Neurobiol Learn Mem"],
    timeline: "4–6 месяцев (после MB-обучения; игрушечная версия — недели)",
